...
# Concepts: randomness, lists, loops, functions, matplotlib                     # Loop = repeat shape-drawing with variations until the final layered artwork appears
...
def random_palette(k=5):                                                        #random_palette() = decide randomly the colors
    # return k random pastel-like colors
    return [(random.random(), random.random(), random.random()) for _ in range(k)]

def blob(center=(0.5, 0.5), r=0.3, points=200, wobble=0.15):                    #blob() = create the shape coordinates
